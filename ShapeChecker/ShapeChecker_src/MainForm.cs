...
namespace ShapeChecker
{
    public partial class MainForm : Form
    {
        ...
        private void ProcessImage( Bitmap bitmap )
        {
            ...
            colorFilter.Red = new IntRange(240, 255);
            colorFilter.Green = new IntRange(240, 255);
            colorFilter.Blue = new IntRange(240, 255);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (isCurrupted)
            {
                txtDecision.Text = "The image uploaded contain currupted dots. Please make sure pressure and other factors are in recommend conditions.";
            }
            else
            {
                txtDecision.Text = "The image uploaded is a good image. Make sure to keep it.";
            }
        }
    }
}
